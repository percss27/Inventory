...
$sql = "INSERT INTO `items` (ItemName,ItemDes,ItemUnit,Quantity,Category) VALUES ('$itemname', '$descript', '$unit','$quantity','School Supplies')";

if (mysqli_query($connection, $sql)) {
    echo '<script>alert("Registration successful!");</script>';
     header('Location: schoolsupplies.php');
} else {
