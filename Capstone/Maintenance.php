...
?>  
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Maintenance Supplies</h1> 
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="index.php">Home</a></li>
          <li class="breadcrumb-item">Maintenance Supplies</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
 ...
 <form class="row g-3 needs-validation" action="addmaintenance.php" method="POST" novalidate>
